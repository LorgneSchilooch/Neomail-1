...
from src.apps.transform_mail.manager.TransformMailManager import TransformMmailManager
...
SCHEMA = "src/apps/utils/data_pipeline/transform_mail/resources/schema/gmail_fields.json"
...
def transform_mail(name_file):
    ...
    # labelling_uri = os.environ.get("FN_BASE_URI", src=False) + '/labelling/' + name_file
