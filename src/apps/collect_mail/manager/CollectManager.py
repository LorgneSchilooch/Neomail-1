...
CLIENT_SECRET = "src/apps/utils/data_pipeline/collect_mail/resources/credentials/gmail_credentials.json"


# CLIENT_SECRET = "src/components/big_query_manager/resources/credentiel_big_query_neomail.json"
