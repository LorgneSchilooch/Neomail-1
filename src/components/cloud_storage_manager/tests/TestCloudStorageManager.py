...
SCHEMA = "src/components/cloud_storage_manager/resources/schema/gmail_transform_fields.json"

"""
Usage: list Data from Cloud storage
python -m src.components.cloud_storage_manager.tests.TestCloudStorageManager
"""

if __name__ == "__main__":
    begin_time = time.time()

    env_path = Path('src/components/cloud_storage_manager/.env')
